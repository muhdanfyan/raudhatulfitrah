spawn ssh pi@210.79.191.137 cat /var/www/pisantri/src/pages/AboutAppPage.tsx
pi@210.79.191.137's password: 
...
export default function AboutAppPage() {
  ...
  const mainFeatures = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1591123120675-6f7f1aae0e5b?w=400&h=250&fit=crop'
    },
    {
      icon: Briefcase,
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            src="https://images.unsplash.com/photo-1577896851231-70ef18881754?w=1920&h=1080&fit=crop" 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            <span className="inline-block px-4 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium mb-4">FITUR UNGGULAN</span>
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-5 py-2 rounded-full text-sm font-semibold mb-4">
              ...
              30 Fitur Terintegrasi
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Daftar Lengkap Semua Fitur</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Semua modul yang tersedia untuk digitalisasi pesantren Anda
            </p>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right">
              <span className="inline-block px-4 py-1 bg-blue-500/20 border border-blue-400/30 rounded-full text-blue-300 text-sm font-medium mb-6">TEKNOLOGI MODERN</span>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="flex items-center gap-3 text-white">
                    ...
                    <div>
                      <div className="font-bold">Dashboard Realtime</div>
                      <div className="text-gray-300 text-sm">Data terupdate setiap detik</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-500 text-sm">Uptime Guaranteed</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center" data-aos="zoom-in">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/ppdb" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-600 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-lg">
              Daftar Sekarang
              <ArrowRight className="w-5 h-5" />
            </Link>
