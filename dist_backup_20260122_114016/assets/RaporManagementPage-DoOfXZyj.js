import{j as e}from"./feature-qr-C9KTTG4-.js";import{r as o}from"./vendor-react-azgetPl6.js";import{c as B,a as Y,j as G,m as S}from"./index-DHDr6u7z.js";import{t as Q}from"./index-DBV0ugPJ.js";import{ap as $,Z as C,as as K,bf as O,p as W,aW as V,an as X,bK as ee,t as te,o as ae,h as se,B as ie,S as ne}from"./vendor-ui-B6e0O3zL.js";import"./vendor-firebase-mGmEEqo4.js";function ge(){const{settings:r}=B(),[x,h]=o.useState(!0),[n,m]=o.useState([]),[u,b]=o.useState([]),[v,q]=o.useState(""),[g,j]=o.useState(()=>{const t=new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`}),[c,M]=o.useState("monthly"),[z,F]=o.useState(()=>new Date().getFullYear()),[f,w]=o.useState(()=>new Date().getMonth()<6?1:2),[p,N]=o.useState(null),[P,T]=o.useState("grid"),[A,L]=o.useState(!1),R=o.useRef(null),i=(r==null?void 0:r.warnaUtama)||"#0f172a";o.useEffect(()=>{U()},[g,c,z,f]),o.useEffect(()=>{if(b(v?n.filter(t=>t.santri.nama_lengkap_santri.toLowerCase().includes(v.toLowerCase())):n),p&&n.length>0){const t=n.find(a=>a.santri.id_santri===p.santri.id_santri);t&&N(t)}},[v,n]);const U=async()=>{h(!0);try{const t=c==="semester"?await Y.getRaporManagementSemester(z,f):await Y.getRaporManagementRealtime(g);t.success&&m(t.data||[])}catch(t){console.error(t)}finally{h(!1)}},k=t=>{const[a,l]=t.split("-");return`${["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"][parseInt(l)-1]} ${a}`},_=()=>`${f===1?"Genap":"Ganjil"} - ${z}`,E=t=>t.split(" ").map(a=>a[0]).join("").substring(0,2).toUpperCase(),J=t=>t>=9?"Mumtaz":t>=8?"Jayyid Jiddan":t>=7?"Jayyid":t>=6?"Maqbul":"Dhaif",H=()=>{if(!p)return;const t=p.santri,a=p.kuantitas,l=p.cohort,d=window.open("","_blank");if(!d)return;const s=i;d.document.write(`
          ...
          <div class="content">
            ...
            <div class="main-area">
              ...
              <div class="stats-col">
                ...
                ${a.rabbani.tahfidz_grade_score>0?`<div class="stat-box" style="background:${s}20;"><span class="val" style="color:${s};">${a.rabbani.tahfidz_grade_score}</span><span class="grade-label" style="color:#4b5563;">${J(a.rabbani.tahfidz_grade_score)}</span><span class="grade-sub">Total Hafalan</span></div>`:""}
